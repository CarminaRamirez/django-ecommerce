# Generated by Django 2.2.14 on 2020-08-06 13:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_type', models.CharField(choices=[('B', 'Envío'), ('S', 'Facturación')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('S', 'remera'), ('SW', 'Ropa deportiva'), ('OW', 'Ropa de salir')], max_length=2)),
                ('label', models.CharField(choices=[('P', 'primario'), ('S', 'secundario'), ('D', 'peligroso')], max_length=1)),
